                ...
                $.fn.floatingScrollbar = function (state) {
                    if (state === false) {
                        ...
                        if (!elems.length) {
                            ...
                            scroller.detach();
                            winNew.unbind('resize scroll', update);
                        }
                    } else if (this.length) {
                        ...
                        if (!elems.length) {
                            ...
                            winNew.resize(update).scroll(update);
                        }
                ...
                function update() {
                    ...
                    elems.each(function () {
                        var elem = $(this),
                            ...
                            viewportBottom = winNew.scrollTop() + winNew.height(),
                            topOffset = 30;
                    ...
                    scroller
                        .css({
                            left: current.offset().left - winNew.scrollLeft(),
                            width: widthOuter
                        })
                        .scrollLeft(scroll);
